...
parser.add_argument('-c', '--counterClockwise', action="store_true", required=False, help="Add this flag if the animation is counter clockwise from above.")
parser.add_argument('--qc', '--quiltColumns', type=int, required=False, default = 8, help="Number of columns in the final quilt.")
parser.add_argument('--qr', '--quiltRows', type=int, required=False, default = 6, help="Number of rows in the final quilt.")
parser.add_argument('--fps', '--frameRate', type=float, required=False, help="Frame rate of final quilt.")
parser.add_argument('--cs', '--cropStart', type=int, required=False, default = 0, help="How many frames to cut from the begining of the animation.")
...
parser.add_argument('-s', '--scale', type=float, required=False, default = 0.25, help="Percentage to scale down the resolution before tiling into a quilt.")
